...
void draw_glyph(enum displayGlyph c, SDL_Rect rect, uint8_t r, uint8_t g, uint8_t b) {
    ...
    if (c < MIN_TILE) {
        ...
        switch(c){
            ...
            convert_glyph(G_TRAP_GAS, 128 + 2, 327)
            convert_glyph(G_TRAP_PARALYSIS, 128 + 2, 327)
            convert_glyph(G_TRAP_CONFUSION, 128 + 2, 327)
            convert_glyph(G_TRAP_FIRE, 128 + 2, 327)
            convert_glyph(G_TRAP_FLOOD, 128 + 2, 327)
            convert_glyph(G_TRAP_NET, 128 + 2, 327)
            convert_glyph(G_TRAP_ALARM, 128 + 2, 380)
            convert_glyph(G_PRESSURE_PLATE, 128 + 2, 327)
            convert_glyph(G_PRESSURE_PLATE_INACTIVE, 128 + 2, 327)
